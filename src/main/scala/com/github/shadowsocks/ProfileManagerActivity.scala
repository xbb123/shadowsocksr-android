...
final class ProfileManagerActivity extends AppCompatActivity with OnMenuItemClickListener with ServiceBoundContext
  ...
  private final class ProfileViewHolder(val view: View) extends RecyclerView.ViewHolder(view)
...

    {
      ...
      shareBtn.setOnClickListener(_ => {
        ...
        val dialog = new AlertDialog.Builder(ProfileManagerActivity.this,android.R.style.Theme.Material.Dialog)
          .setCancelable(true)
  ...
  override def onCreate(savedInstanceState: Bundle) {
    ...
    if (app.settings.getBoolean(Key.profileTip, true)) {
      ...
      new AlertDialog.Builder(this,android.R.style.Theme.Material.Dialog.Alert).setTitle(R.string.profile_manager_dialog)
  ...
  override def onClick(v: View){
    v.getId match {
      ...
      case R.id.fab_nfc_add =>
        menu.toggle(true)
        val dialog = new AlertDialog.Builder(ProfileManagerActivity.this,android.R.style.Theme.Material.Dialog.Alert)
          .setCancelable(true)
  ...
  def handleShareIntent(intent: Intent) {
    ...
    val dialog = new AlertDialog.Builder(this,android.R.style.Theme.Material.Dialog.Alert)
